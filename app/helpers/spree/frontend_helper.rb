  ...
  module FrontendHelper
    ...
    def breadcrumbs(taxon, separator="&nbsp;")
      ...
      if taxon
        ...
        crumbs << content_tag(:li, content_tag(:span, link_to(content_tag(:span, Spree.t(:greetingcards), itemprop: "name"), spree.greetingcards_path, itemprop: "url") + separator, itemprop: "item"), itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
        ...
        crumbs << content_tag(:li, content_tag(:span, Spree.t(:greetingcards), itemprop: "item"), class: 'active', itemscope: "itemscope", itemtype: "https://schema.org/ListItem", itemprop: "itemListElement")
      end
