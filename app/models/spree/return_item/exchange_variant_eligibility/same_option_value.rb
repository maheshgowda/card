  ...
  module ReturnItem::ExchangeVariantEligibility
    class SameOptionValue
      ...
      def self.eligible_variants(variant)
        ...
        greetingcard_variants = SameGreetingcard.eligible_variants(variant).includes(option_values: :option_type)
        ...
        if relevant_option_values.present?
          ...
          greetingcard_variants.select { |v| (relevant_option_values & v.option_values) == relevant_option_values }
        else
          product_variants
          greetingcard_variants
        end
      end
    end
  end
