  ...
  describe "preference access" do
    ...
    context "converts any preferences to any values" do
      before do
        ...
        A.preference :greetingcard_ids, :any, :default => []
        A.preference :greetingcard_attributes, :any, :default => {}
      end
      ...
      it "with array" do
        ...
        expect(@a.preferences[:greetingcard_ids]).to eq([])
        @a.set_preference(:greetingcard_ids, [1, 2])
        expect(@a.preferences[:greetingcard_ids]).to eq([1, 2])
      end
