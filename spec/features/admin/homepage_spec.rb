...
describe "Homepage", :type => :feature do
  ...
  context 'as admin user' do
    ...
    context "visiting the homepage" do
      ...
      it "has a link to greetingcards" do
        page.find_link("greetingcards")['/admin/greetingcards']
      end
    ...
    context "visiting the greetingcards tab" do
      before(:each) do
        visit spree.admin_greetingcards_path
      end

      it "has a link to greetingcards" do
        within('.sidebar') { page.find_link("greetingcards")['/admin/greetingcards'] }
      end
  ...
  context 'as fakedispatch user' do
    ...
    it 'only displays tabs fakedispatch has access to' do
      ...
      expect(page).not_to have_link('Greetingcards')
