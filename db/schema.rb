...
ActiveRecord::Schema.define(version: 20160420113230) do
  ...
  create_table "spree_greetingcard_option_types", force: :cascade do |t|
    t.integer  "position"
    t.integer  "greetingcard_id"
    t.integer  "option_type_id"
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
  end

  add_index "spree_greetingcard_option_types", ["greetingcard_id"], name: "index_spree_greetingcard_option_types_on_greetingcard_id"
  add_index "spree_greetingcard_option_types", ["option_type_id"], name: "index_spree_greetingcard_option_types_on_option_type_id"
  add_index "spree_greetingcard_option_types", ["position"], name: "index_spree_greetingcard_option_types_on_position"
  ...
  add_index "spree_greetingcards", ["shipping_category_id"], name: "index_spree_greetingcards_on_shipping_category_id"
  add_index "spree_greetingcards", ["slug"], name: "index_spree_greetingcards_on_slug", unique: true
  add_index "spree_greetingcards", ["tax_category_id"], name: "index_spree_greetingcards_on_tax_category_id"

  create_table "spree_greetingcards_promotion_rules", id: false, force: :cascade do |t|
    t.integer "greetingcard_id"
  ...
  create_table "spree_greetingcards_taxons", force: :cascade do |t|
    t.integer "greetingcard_id"
    t.integer "taxon_id"
    t.integer "position"
  end
  ...
  add_index "spree_greetingcards_taxons", ["position"], name: "index_spree_greetingcards_taxons_on_position"
  ...
  create_table "spree_promotion_rules", force: :cascade do |t|
    ...
    t.integer  "greetingcard_group_id"
    t.string   "type"
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
    t.string   "code"
  ...
  add_index "spree_promotion_rules", ["greetingcard_group_id"], name: "index_promotion_rules_on_greetingcard_group_id"
