...
describe Spree::TaxRate, :type => :model do
  ...
  describe ".adjust" do
    ...
    context "for MOSS taxation in Europe" do
      ...
      let(:download) { create(:greetingcard, tax_category: moss_category, price: 10) }
      let(:birthday card) { create(:greetingcard, tax_category: normal_category, price: 10) }
  ...
  describe "#adjust" do
    before do
      ...
      @taxable     = create(:greetingcard, :tax_category => @category)
      @nontaxable  = create(:greetingcard, :tax_category => @category2)
    end
