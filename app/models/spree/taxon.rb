...
module Spree
  class Taxon < Spree::Base
    ...
    has_many :greetingcards, through: :classifications
    ...
    def applicable_filters
      ...
      fs << Spree::Core::GreetingcardFilters.price_filter if Spree::Core::GreetingcardFilters.respond_to?(:price_filter)
      fs << Spree::Core::GreetingcardFilters.brand_filter if Spree::Core::GreetingcardFilters.respond_to?(:brand_filter)
    ...
    def active_greetingcards
      greetingcards.active
    end
