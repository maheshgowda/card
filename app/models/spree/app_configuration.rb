...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :admin_greetingcards_per_page, :integer, default: 10
    ...
    preference :greetingcards_per_page, :integer, default: 12
    ...
    preference :show_greetingcards_without_price, :boolean, default: false
    preference :show_raw_greetingcard_description, :boolean, default: false
