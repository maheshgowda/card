...
describe Spree::Ability, :type => :model do
  ...
  context 'for admin protected resources' do
    ...
    let(:resource_greetingcard) { Spree::Greetingcard.new }
    ...
    context 'with admin user' do
      it 'should be able to admin' do
        ...
        expect(ability).to be_able_to :show, resource_greetingcard
    ...
    context 'with fakedispatch user' do
      it 'should be able to admin on the order and shipment pages' do
        ...
        expect(ability).not_to be_able_to :admin, resource_greetingcard
        expect(ability).not_to be_able_to :update, resource_greetingcard
  ...
  context 'as Guest User' do
    ...
    context 'for Greetingcard' do
      let(:resource) { Spree::Greetingcard.new }
      context 'requested by any user' do
        it_should_behave_like 'read only'
      end
    end
